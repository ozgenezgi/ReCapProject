...
using ReCapBusiness.BusinessAspects.Autofac;
using ReCapBusiness.Constants;
using ReCapBusiness.ValidationRules.FluentValidation;
using ReCapDataAccess.Abstract;
using ReCapEntities.Concrete;

namespace ReCapBusiness.Concrete
{
    public class CarImageManager : ICarImagesServices
    {
        ...
        {
            string path = @"D:\ReCapProject\ReCapProject\WebAPI\Images\logo.jpg";
